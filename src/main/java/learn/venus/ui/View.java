...
public class View {             //display menu, prints to console
    ...
    public Orbiter makeOrbiter() {
        ...
        orbiter.setName(readRequireString("Name: "));
    ...
    private String readRequireString (String prompt) {
        String result = null;
        do{
    ...
    private int readInt(String prompt) {
        ...
        do {
            String value = readRequireString(prompt);
            try {
    ...
    private int readInt (String prompt, int min, int max) {
        ...
        do {
            ...
            if (result < min || result > max) {
                System.out.printf("Value must be %s and %s%n", min, max);
            }
